...
double code_match(code* coder1, code* coder2) {
	//return coder_lbp_match(coder1->eye, coder1->code_lbp, coder2->eye, coder2->code_lbp);
	//return coder_blob_match(coder1->eye, coder1->code_blob, coder2->eye, coder2->code_blob);
	return coder_spatiogram_match(coder1->code_spatiogram, coder2->code_spatiogram);
	/*double lbp_sim = coder_lbp_match(coder1->eye, coder1->code_lbp, coder2->eye, coder2->code_lbp);
